...
import 'package:bajar247/controllers/eCommerce/flash_sales/flash_sales_controller.dart';
...
import 'package:bajar247/models/eCommerce/product/product.dart'
    as product;
...
import 'package:bajar247/views/eCommerce/home/components/shop_card.dart';
          ...
          child: Column(
            ...
            children: [
              ref.read(hiveServiceProvider).userIsLoggedIn()
                  ...
                  : const AppLogo(isAnimation: true, centerAlign: false, withAppName: false,),
            ],
          ),
        );
      },
