...
import 'package:bajar247/generated/intl/messages_ar.dart';
import 'package:bajar247/models/eCommerce/common/common_response.dart';
import 'package:bajar247/models/eCommerce/order/add_product_review_model.dart';
import 'package:bajar247/models/eCommerce/order/buy_now_order_place.dart';
import 'package:bajar247/models/eCommerce/order/order_model.dart';
import 'package:bajar247/models/eCommerce/order/order_place_model.dart';
import 'package:bajar247/services/eCommerce/order/order_service.dart';
import 'package:bajar247/utils/global_function.dart';
import 'package:bajar247/utils/request_handler.dart';
...
class OrderController extends StateNotifier<bool> {
  ...
  Future<CommonResponse> orderAgain({required int orderId , required String paymentMethod}) async {
    try {
      state = true;
      final response =
          await ref.read(orderServiceProvider).orderAgain(orderId: orderId , paymentMethod: paymentMethod);
